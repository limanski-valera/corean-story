    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".product-small-images__slider") && document.querySelector(".product-big-images__slider")) {
                const smallImageSlider = new swiper_core_Swiper(".product-small-images__slider", {
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                    spaceBetween: 20,
                ...
                new swiper_core_Swiper(".product-big-images__slider", {
        ...
        function initCart() {
            if (document.querySelector(".cart")) {
                ...
                document.querySelector(".cart__close-btn");
                function openCart() {
        ...
        function initCatalog() {
            if (document.documentElement.clientWidth > 767.98) {
                ...
                function closeCatalog(e) {
                    if (e.target.closest("[data-catalog]") && e.target.closest(".menu__link")) e.preventDefault(); else if (!e.target.closest(".header")) {
                        document.documentElement.classList.remove(activeClass);
                ...
                document.addEventListener("click", (e => {
                    if (e.target.closest(".sub-menu__link")) {
                        ...
                        categoriesButtonsList.forEach((button => {
                            if (button == e.target.closest(".sub-menu__link") && !button.closest(".sub-menu__item").classList.contains("_active")) button.closest(".sub-menu__item").classList.add("_active"); else if (button.closest("._active") && button != e.target.closest(".sub-menu__link")) button.closest(".sub-menu__item").classList.remove("_active");
                        }));
                    }
                }));
            }
        ...
        function initDownloadInput() {
            if (document.querySelector(".download-input")) {
                ...
                function addFilesString(files, filesLength) {
                    ...
                    for (let i = 0; i < filesLength; i++) filesNamesArray.push(files[i].name);
